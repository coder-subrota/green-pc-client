...
const EditProduct = () => {
    ...
    const onSubmit = async (productData) => {
        ...
        try {
            let uploadedUrl = product?.productImage; 
            ...
            if (productImage) {
                ...
                const imgRes = await fetch(`https://api.imgbb.com/1/upload?key=${image_bb_key}`, {
                    method: "POST",
                    body: formData,
                });
            ...
            const updateInformation = {
                ...
                categoryId: categoryInfo?._id ? categoryInfo._id.trim() : (product?.categoryId || ""),
                ...
                productImage: uploadedUrl.trim(), // Old or New image url
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
            <Helmet><title>Edit a Product | Dashboard</title></Helmet>
            ...
            <div className="max-w-5xl w-full bg-white rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-12">
                ...
                <div className="md:col-span-4 bg-gradient-to-br from-blue-600 to-indigo-800 p-8 flex flex-col justify-between text-white text-center md:text-left">
                    ...
                    <div className="my-8 md:my-0 flex justify-center">
                        {product?.productImage && (
                            <img
                                src={productImage ? URL.createObjectURL(productImage) : product?.productImage}
                                alt="product preview"
                                className="h-48 w-full object-cover rounded-xl filter drop-shadow-lg"
                            />
                        )}
                    </div>
                    <div>
                ...
                <div className="md:col-span-8 p-8 sm:p-12">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 pb-5 mb-6">
                        <div>
                            <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight"> Edit Product</h2>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col">
                                ...
                                <input
                                    type="text"
                                    placeholder="e.g., Ryzen 5 5600X Setup"
                        ...
                        <div className="flex flex-col">
                            ...
                            <textarea
                                placeholder="Describe the specifications, usage history..."
                                ...
                                {isDragActive ? (
                                    ...
                                    <div className="border-2 border-dashed border-gray-300 hover:border-blue-500 hover:bg-gray-50 py-8 px-4 rounded-xl flex flex-col items-center justify-center text-center transition-all duration-200">
                                        ...
                                        <p className="text-sm font-medium text-emerald-600">
                                            Selected File: {productImage ? productImage.name : (product?.productImage ? "Existing Image Used" : "No file selected")}
                                        </p>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="pt-2">
                            <button 
                                type="submit"
                                disabled={loading}
                                className="w-full flex justify-center items-center py-3 px-4 rounded-lg text-base font-bold text-cyan-700 bg-blue-700 hover:bg-blue-800 text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-400 disabled:cursor-not-allowed transition-all duration-300 shadow-md hover:shadow-lg"
                            >
